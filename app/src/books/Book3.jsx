  ...
  return (
    <Container>
      <BookCover>
        ...
        <Subtitle>หากวันใดที่โลกไม่เป็นใจ หรือท้องฟ้าไม่สดใส<br />ฉันพร้อมจะเป็นพื้นที่ปลอดภัยให้เธอได้พักพิง</Subtitle>
        <Author>บ้านข้างๆ</Author>
        <ToggleTocButton onClick={toggleTOC}>Contents</ToggleTocButton>
